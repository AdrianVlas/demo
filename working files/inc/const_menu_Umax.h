...
#define EKRAN_SETPOINT_UMAX_GROUP1   (EKRAN_CHOSE_SETTINGS + 1)
...
#define EKRAN_TIMEOUT_UMAX_GROUP1    (EKRAN_SETPOINT_CTRL_PHASE_GROUP4 + 1)
...
#define EKRAN_CONTROL_UMAX           (EKRAN_TIMEOUT_CTRL_PHASE_GROUP4  + 1)
