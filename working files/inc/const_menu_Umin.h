...
#define EKRAN_SETPOINT_UMIN_GROUP1   (EKRAN_CHOSE_SETTINGS + 1)
...
#define EKRAN_TIMEOUT_UMIN_GROUP1    (EKRAN_SETPOINT_CTRL_PHASE_GROUP4 + 1)
...
#define EKRAN_CONTROL_UMIN           (EKRAN_TIMEOUT_CTRL_PHASE_GROUP4  + 1)
