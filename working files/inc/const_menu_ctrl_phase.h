...
#define EKRAN_SETPOINT_CTRL_PHASE              (EKRAN_CHOSE_SETTINGS + 1)
#define EKRAN_TIMEOUT_CTRL_PHASE               (EKRAN_SETPOINT_CTRL_PHASE + 1)
#define EKRAN_CONTROL_CTRL_PHASE               (EKRAN_TIMEOUT_CTRL_PHASE + 1)
