...
#define EKRAN_SETPOINT_UROV_GROUP1 (EKRAN_CHOSE_SETTINGS             + 1)
...
#define EKRAN_TIMEOUT_UROV_GROUP1  (EKRAN_SETPOINT_CTRL_PHASE_GROUP4         + 1)
...
#define EKRAN_CONTROL_UROV         (EKRAN_TIMEOUT_CTRL_PHASE_GROUP4                + 1)
