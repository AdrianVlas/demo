...
#define EKRAN_SETPOINT_ZOP_GROUP1 (EKRAN_CHOSE_SETTINGS + 1)
...
#define EKRAN_TIMEOUT_ZOP_GROUP1  (EKRAN_SETPOINT_CTRL_PHASE_GROUP4  + 1)
...
#define EKRAN_CONTROL_ZOP         (EKRAN_TIMEOUT_CTRL_PHASE_GROUP4  + 1)
