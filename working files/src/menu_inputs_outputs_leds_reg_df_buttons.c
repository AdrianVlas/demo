...
void make_ekran_chose_of_inputs_outputs_leds_df_buttons_for_ranguvannja(unsigned int type_of_window)
{
  ...
  {
    {" Двых           ", " Св             ", " О-функция      ", " F              ", " О-триггер      ", " О-И            ", " О-ИЛИ          ", " О-Искл.ИЛИ     ", " О-НЕ           "},
    {" Двих           ", " Св             ", " В-функція      ", " F              ", " В-триґер       ", " В-І            ", " В-АБО          ", " В-Викл.АБО     ", " В-НЕ           "},
    {" DO             ", " LED            ", " UD Function    ", " F              ", " UD Flip-Flop   ", " UD AND         ", " UD OR          ", " UD XOR         ", " UD NOT         "},
    {" Двых           ", " Св             ", " О-функция      ", " F              ", " О-триггер      ", " О-И            ", " О-ИЛИ          ", " О-Искл.ИЛИ     ", " О-НЕ           "}
  };

  const unsigned int first_index_number[MAX_NAMBER_LANGUAGE][MAX_NUMBER_ID_RANG_SOURCE] = 
  {
    {5, 3, 10, 2, 10, 4, 6, 11, 5},
    {5, 3, 10, 2,  9, 4, 6, 11, 5},
    {3, 4, 12, 2, 13, 7, 6,  7, 6},
    {5, 3, 10, 2, 10, 4, 6, 11, 5}
  };
...
#define NUMBER_ROW_FOR_NOTHING_INFORMATION 2
  ...
  else
  {
    ...
    int min_max_number[TOTAL_NUMBER_PROTECTION][2] ={
                                                     {-1,-1},
                                                     {
                                                      (NUMBER_GENERAL_SIGNAL_FOR_RANG_BUTTON + NUMBER_CTRL_PHASE_SIGNAL_FOR_RANG_BUTTON),
                                                      (NUMBER_GENERAL_SIGNAL_FOR_RANG_BUTTON + NUMBER_CTRL_PHASE_SIGNAL_FOR_RANG_BUTTON + NUMBER_EL_SIGNAL_FOR_RANG_BUTTON - 1)
                                                     }
                                                    };
