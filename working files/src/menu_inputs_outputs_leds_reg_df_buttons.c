...
#define NUMBER_ROW_FOR_NOTHING_INFORMATION 2
  ...
  else
  {
    ...
    int min_max_number[TOTAL_NUMBER_PROTECTION][2] =
    {
      {-1,-1},
      {
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_INPUT + NUMBER_CTRL_PHASE_SIGNAL_FOR_RANG_INPUT),
       (NUMBER_GENERAL_SIGNAL_FOR_RANG_INPUT + NUMBER_CTRL_PHASE_SIGNAL_FOR_RANG_INPUT + NUMBER_EL_SIGNAL_FOR_RANG_INPUT - 1)
      }
     };
